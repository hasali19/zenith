...
data class MediaLoadRequestData (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MediaLoadRequestData) {
      return false
    }
    if (this === other) {
      return true
...
data class MediaMetadataImage (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is MediaMetadataImage) {
      return false
    }
    if (this === other) {
      return true
