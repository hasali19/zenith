...
class VideoUserData extends Table
    with TableInfo<VideoUserData, VideoUserDataData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VideoUserData(this.attachedDatabase, [this._alias]);
  ...
  @override
  VideoUserData createAlias(String alias) {
    return VideoUserData(attachedDatabase, alias);
  }
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final VideoUserData videoUserData = VideoUserData(this);
  @override
