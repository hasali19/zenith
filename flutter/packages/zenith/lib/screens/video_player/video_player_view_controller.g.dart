...
final class VideoPlayerViewControllerProvider
    extends
        $AsyncNotifierProvider<VideoPlayerViewController, VideoPlayerState> {
...
String _$videoPlayerViewControllerHash() =>
    r'818e532f1d7d6f243c1d1f0c4a0894a57aaa23c1';
...
final class VideoPlayerViewControllerFamily extends $Family
  ...
  VideoPlayerViewControllerProvider call(int id) =>
...
abstract class _$VideoPlayerViewController
  ...
  FutureOr<VideoPlayerState> build(int id);
  @$mustCallSuper
  @override
  void runBuild() {
    final ref =
